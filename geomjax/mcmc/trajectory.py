...
from geomjax.mcmc.integrators import IntegratorState
...
from geomjax.types import ArrayTree, PRNGKey
    ...
    def integrate(
        ...
        def add_one_state(loop_state):
            ...
            (new_trajectory, sampled_proposal) = jax.lax.cond(
                ...
                lambda _: (
                    Trajectory(
                        new_state, new_state, new_state.momentum, new_state.velocity, 1
                    ),
                    new_proposal,
                ),
                lambda _: (
...
def dynamic_recursive_integration(
    ...
    def buildtree_integrate(
        ...
        if tree_depth == 0:
            ...
            is_diverging = -new_proposal.weight > divergence_threshold
            trajectory = Trajectory(
                next_state, next_state, next_state.momentum, next_state.velocity, 1
            )
            return (
                rng_key,
                new_proposal,
